 ...
 *
 * <p>The time taken by this algorithm is always runs O(n^2) time even if the array is sorted. It
 * can be optimized by stopping the algorithm if the inner loop didn't cause any swap.
 */
