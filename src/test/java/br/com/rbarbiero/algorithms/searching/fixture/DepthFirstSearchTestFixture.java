...
import br.com.rbarbiero.datastructure.graph.AdjacencyList;

public class DepthFirstSearchTestFixture {

  public static Graph undirectedIntegersAdjacencyList() {

    final Graph representation = new AdjacencyList(10);
